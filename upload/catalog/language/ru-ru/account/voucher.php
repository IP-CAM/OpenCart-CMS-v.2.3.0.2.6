...
$_['text_message']     = '<p>Благодарим Вас за покупку подарочного сертификата! После завершения заказа вашему получателю подарочного сертификата будет отправлено письмо с подробностями, как им воспользоваться.</p>';
