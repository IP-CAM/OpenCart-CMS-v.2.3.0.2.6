...
$_['help_ssl']                         = 'Включая полный URL к магазину. Добавьте \'/\' в конце. Например: https://wwww.yourdomain.com/path/ не используйте в качестве адреса директорию основного магазина используйте новый домен или суб домен.';
