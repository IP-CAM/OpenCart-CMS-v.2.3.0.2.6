...
$_['text_session']                    = 'Warning! If, due to the settings of the sessions, it stopped letting in the admin panel or other errors, then comment out the code for setting the session settings in controller/startup/setting.php. It is recommended that you set up sessions by a professional.';
...
$_['entry_action_not_found']          = '404 for controllers';
...
$_['entry_session_bits_per_char']     = 'Number of bits per character';
$_['entry_session_length']            = 'Session name length';
$_['entry_session_lifetime']          = 'Session cookie lifetime';
$_['entry_session_maxlifetime']       = 'Maximum session cookie lifetime';
$_['entry_session_other_lifetime']    = 'The lifetime of other cookies';
$_['entry_session_probability']       = 'Probability';
$_['entry_session_divisor']           = 'Divisor';
$_['entry_session_samesite']          = 'SameSite session cookie attribute';
$_['entry_session_other_samesite']    = 'SameSite attribute for other cookies';
$_['entry_session_sameparty']         = 'SameParty session cookie attribute';
$_['entry_session_other_sameparty']   = 'SameParty attribute for other cookies';
$_['entry_robots']                    = 'Robots';
$_['entry_seo_url']                   = 'Use SEO URLs';
$_['entry_seo_url_type']              = 'URLs type';
...
$_['entry_seo_url_break_routes']      = 'Exception from processing';
$_['entry_seo_url_get_params_status'] = 'Exclude allowed get-parameters';
$_['entry_seo_url_get_params']        = 'Allowed get-parameters';
...
$_['help_mail_smtp_hostname']         = 'Add \'tls://\' or \'ssl://\' prefix if security connection is required. (e.g. tls://smtp.gmail.com, ssl://smtp.gmail.com). The default is \'tls://\'.';
...
$_['help_action_not_found']           = 'Add the controller route to be replaced with the 404 error controller. If you want a replacement for all routes, use \'#\' instead of the route. If you need to replace on a specific page, then after the route, specify \'|\' followed by an unwanted internal link (no domain) or part of the options. If you need a hard check on the link, then specify \'|\'. If you need to disable all parameters, except for certain ones, then after \'|\' specify allowed parameters through \',\'. The value is set starting from a new line. If you do not want to delete, then at the beginning of the line set \';\'.';
...
$_['help_session_engine']             = 'Native by default. Choose how you will store sessions.<br />DataBase - mysql processes sessions and stores cookies in the session table.<br />File - processes sessions as cache files and stores cookies in the folder: \'' . str_replace(DIR_SYSTEM, 'system/', DIR_SESSION) . '\'.<br />Native - sessions are handled by the SessionHandler class and cookies are stored in their path.';
$_['help_session_name']               = 'The default is PHPSESSID. Here you can specify your own name for the cookie responsible for storing the name of the session file.';
$_['help_session_prefix']             = 'By default sess_. The session file name prefix is intended to make it difficult for an attacker to find the session file to retrieve its contents.';
$_['help_session_bits_per_char']      = 'The default is 4. Available values:<br />4 - (0-9, a-f);<br />5 - (0-9, a-v);<br />6 - (0-9, a-z, A-Z, \'-\', \',\'). The more bits, the stronger the session identifier. In most environments, 5 is recommended.';
$_['help_session_length']             = 'The default is 32. The length of the session name is counted with the length of the prefix. The maximum length for session types Native and File is 128 characters, and for DataBase 255. A minimum of 32 characters is recommended.';
$_['help_session_lifetime']           = 'Default 0. Session cookie lifetime is set in seconds. 0 - means that the session will be invalid after closing the browser and will be deleted on the next visit.';
$_['help_session_maxlifetime']        = 'The default is 1440 seconds (24 minutes). The lifetime of a session cookie is specified in seconds. Specify the maximum time threshold after which the session will be discarded by the garbage collector. It is advisable to set the time not less than the lifetime of the session cookie.';
$_['help_session_other_lifetime']     = 'The default is 2592000 seconds (1 month). The lifetime of other cookies is set in seconds. 0 - means that cookies will be invalid after closing the browser and deleted on subsequent visit.';
$_['help_session_probability']        = 'Default 1. This setting is intended for the garbage collector, so as not to burden the server with constant requests to delete old session files. The probability is indicated in whole numbers. Example, 1/1000 - where 1 is the probability, 1000 is the divisor, that is, the chance to remove garbage when loading the page is 1 to 1000.';
$_['help_session_divisor']            = 'The default is 1000. This setting is intended for the garbage collector, so as not to burden the server with constant requests to delete old session files. The divisor is indicated in integers. Example, 1/1000 - where 1 is the probability, 1000 is the divisor, that is, the chance to remove garbage when loading the page is 1 to 1000.';
$_['help_session_samesite']           = 'Default Strict<br />None - Cookies will be sent in all contexts, i.e in responses to both first-party and cross-origin requests.If SameSite=None is set, the cookie Secure attribute must also be set (or the cookie will be blocked).<br />Lax - Cookies are not sent on normal cross-site subrequests (for example to load images or frames into a third party site), but are sent when a user is navigating to the origin site (i.e. when following a link).<br />Strict - Cookies will only be sent in a first-party context and not be sent along with requests initiated by third party websites.';
$_['help_session_other_samesite']     = 'Default Lax<br />None - Cookies will be sent in all contexts, i.e in responses to both first-party and cross-origin requests.If SameSite=None is set, the cookie Secure attribute must also be set (or the cookie will be blocked).<br />Lax - Cookies are not sent on normal cross-site subrequests (for example to load images or frames into a third party site), but are sent when a user is navigating to the origin site (i.e. when following a link).<br />Strict - Cookies will only be sent in a first-party context and not be sent along with requests initiated by third party websites.';
$_['help_session_sameparty']          = 'Default No<br />';
$_['help_session_other_sameparty']    = 'Default No<br />';
...
$_['help_seo_url_break_routes']       = 'Add the controller route to be excluded from SEO_URL processing. Each value on a new line.<br />(SeoPro only)';
$_['help_seo_url_get_params_status']  = 'Disables call forwarding for the item from the allowed list of get-parameters (utm-tags).';
$_['help_seo_url_get_params']         = 'Each get-parameter from a new line.';
