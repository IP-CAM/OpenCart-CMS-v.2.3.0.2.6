...
$_['help_action_not_found']           = 'Add the controller route to be replaced with the 404 error controller. Each value on a new line. If you need to replace on a specific page, then after the route, specify \' | \' followed by an unwanted internal link (no domain) or part of the options. If you want a replacement for all routes, use \' # \' instead of the route. If you need a hard check on the link, then specify \' | \'. If you need to disable all parameters, except for certain ones, then after \' | \' specify allowed parameters through \' , \'.';
