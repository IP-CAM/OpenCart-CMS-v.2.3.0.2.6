  ...
  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-refresh fa-lg"></i></a>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="https://opencart.pro/blog/" rel="noreferrer noopener" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="https://opencart.pro/wiki/" rel="noreferrer noopener" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="https://forum.opencart.pro/" rel="noreferrer noopener" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
