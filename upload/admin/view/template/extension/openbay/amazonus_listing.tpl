      ...
      success: function(data) {
        if (data.error){
          ...
          $.each(data['data'], function(index, value) {
            ...
            html += '    <a href="' + value.link + '" class="btn btn-primary" data-toggle="tooltip" title="<?php echo $button_view_on_amazon; ?>" rel="noreferrer noopener" target="_blank"><i class="fa fa-eye"></i></a>';
