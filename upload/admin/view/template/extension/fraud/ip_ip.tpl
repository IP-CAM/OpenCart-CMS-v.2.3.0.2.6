<div class="table-responsive">
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        <td class="text-left"><a href="https://www.geoiptool.com/en/?IP=<?php echo $ip['ip']; ?>" rel="noreferrer noopener" target="_blank"><?php echo $ip['ip']; ?></a></td>
        <td class="text-right"><a href="<?php echo $ip['filter_ip']; ?>" rel="noreferrer noopener" target="_blank"><?php echo $ip['total']; ?></a></td>
